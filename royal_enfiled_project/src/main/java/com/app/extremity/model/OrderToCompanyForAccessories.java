...
@Entity
public class OrderToCompanyForAccessories
{
	@Id
...
private AddAccessories addAccessories;

public AddAccessories getAddAccessories() {
	return addAccessories;
}
public void setAddAccessories(AddAccessories addAccessories) {
