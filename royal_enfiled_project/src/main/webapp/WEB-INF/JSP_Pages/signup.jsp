...
<div class="form-group"> <label class="control-label">Email</label> <input type="text" name="email"placeholder="test@example.com"class="form-control inputdefault" data-required="true" data-email="true"> 
${msg}
</div>
<div class="form-group"> 
...
<div class="form-group"> 
<label class="control-label">Contact Number</label> <input type="text" name="mobile"placeholder="eg. 967*****66"class="form-control inputdefault"> </div>
<div class="form-group"> <label class="control-label">Email</label> <input type="text" name="email"placeholder="test@example.com"class="form-control inputdefault"> </div>
${msg}
<div class="form-group"> 
<label class="control-label">Country</label>
<!-- @author Sonika Takalkar-->
