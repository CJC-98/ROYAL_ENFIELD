...
<body>
    ...
    <aside id="left-panel" class="left-panel" style="background: #34588a;">
        <nav class="navbar navbar-expand-sm navbar-default" style="background: #34588a;"> 
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse" style="background: #34588a;">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    <h3 class="menu-title">UI elements</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown" style="background: #34588a;">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Components</a>
                        <ul class="sub-menu children dropdown-menu" style="background: #34588a;">
