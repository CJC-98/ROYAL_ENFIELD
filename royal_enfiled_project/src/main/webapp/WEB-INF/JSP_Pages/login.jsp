            ...
            <section class="panel panel-default bg-white m-t-lg">
                ...
                <form action="http://flatfull.com/them	es/note/index.html" class="panel-body wrapper-lg">
                    ...
                    <div class="checkbox"> <label> <input type="checkbox"> Keep me logged in </label> </div> <a href="#"
                        class="pull-right m-t-xs"><small>Forgot password?</small></a> <a href="Sign in"><button type="submit" class="btn btn-primary">Sign in</button></a>
                    <div class="line line-dashed"></div> <a href="#" class="btn btn-facebook btn-block m-b-sm"><i class="fa fa-facebook pull-left"></i>Sign
                        in with Facebook</a> <a href="#" class="btn btn-twitter btn-block"><i class="fa fa-twitter pull-left"></i>Sign
                        in with Twitter</a>
                    <div class="line line-dashed"></div>
                    <p class="text-muted text-center"><small>Do not have an account?</small></p> <a href="signup.html"
...
<!-- Mirrored from flatfull.com/themes/note/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Oct 2018 11:17:05 GMT -->
