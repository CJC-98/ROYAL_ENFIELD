...
<body class="">
	...
	<ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
		<li class="hidden-xs"><a href="#" class="dropdown-toggle dk"
			data-toggle="dropdown"> <i class="fa fa-bell"></i> <span
				...
				class="panel bg-white"> <!-- This for notification block -->
			<header class="panel-heading b-light bg-light"> <strong>You
				have <span class="count">2</span> notifications
			</strong> </header>

			<div class="list-group list-group-alt animated fadeInRight">
				<a href="#" class="media list-group-item"> <span
					class="pull-left thumb-sm"> <img src="images/Nikita.jpg"
						alt="Nikita said" class="img-circle">
				</span> <span class="media-body block m-b-none"> Use awesome
						animate.css<br> <small class="text-muted">10 minutes
							ago</small>
				</span>
			...
			<footer class="panel-footer text-sm"> <a href="#"
				class="pull-right"><i class="fa fa-cog"></i></a> <a href="#notes"
				data-toggle="class:show animated fadeInRight">See all the
				notifications</a> </footer> <!-- This for notification block --> </section> </section></li>
		<!-- Search_icon Block -->
		<li class="dropdown hidden-xs"><a href="#"
			class="dropdown-toggle dker" data-toggle="dropdown"><i
				class="fa fa-fw fa-search"></i></a> <section
				class="dropdown-menu aside-xl animated fadeInUp"> <section
		...
		<li class="dropdown"><a href="#" class="dropdown-toggle"
			...
			</span>Nikita_Pise <b class="caret"></b>
		</a>
	...
	<div class="slim-scroll" data-height="auto"
		...
		<ul class="nav">
			...
			</a> <!-- This for sublist of Add -->
				<ul class="nav lt">
					<li><a href=""> <i class="fa fa-angle-right"><b
								class="bg-danger"></b></i><span class="pull-right"> <i
								class="fa fa-angle-down text"></i> <i
								class="fa fa-angle-up text-active"></i>
						</span> <span>Manager</span>
					</a> <!-- this for sublist of Manager -->
						<ul class="nav lt">
							<li><a href="saleManager.html" class="active"> <span>SalesManager</span>
							</a></li>
							<li><a href="ServiceManager.html" class="active"> <span>ServiceManager</span>
							</a></li>
						</ul> <!-- end of sublist of Manager --></li>

					<li><a href=""> <i class="fa fa-angle-right"> <b
								class="bg-danger"></b></i> <span>Accountant</span>
					</a></li>


				</ul> <!-- end of sublist of Add --></li>
			<!-- This for User -->
			...
			<li><a href="#stock"> <i class="fa fa-flask icon"> <b
						class="bg-success"></b>
				</i> <span class="pull-right"> <i class="fa fa-angle-down text"></i>
						<i class="fa fa-angle-up text-active"></i>
				...
				<ul class="nav lt">
					<li><a href=""> <i class="fa fa-angle-right"><b
						...
						<ul class="nav lt">
							<li><a href="" class="active"> <span>New_Bike</span>
							</a></li>
							<li><a href="" class="active"> <span>Old_Bike</span>
							</a></li>
						</ul> <!-- end of sublist of Bike --></li>
					<li><a href="accessories.html"> <i
							class="fa fa-angle-right"></i> <span>Accesories</span>
					</a></li>

					<li><a href=""> <i class="fa fa-angle-right text"></i> <i
							class="fa fa-angle-down text-active"></i> <span>Dead_stock</span>
					</a>
						<ul class="nav bg">
							<li><a href="deadbike.html"> <i
									class="fa fa-angle-right"></i> <span>Dead_Bike</span>
							</a></li>
							<li><a href="deadaccessories.html"> <i
									class="fa fa-angle-right"></i> <span>Dead_Accessories</span>
							</a></li>
						</ul></li>
			...
			<li><a href="#stock"> <i class="fa fa-flask icon"> <b
						...
						class="fa fa-angle-up text-active"></i> <i
						class="fa fa-angle-down text"></i></span> <span>Sale</span>
			</a>
				<ul class="nav lt">
					<li><a href=""> <i class="fa fa-angle-right"><b
								class="bg-danger"></b></i><span class="pull-right"> <i
								class="fa fa-angle-up text-active"></i> <i
								class="fa fa-angle-down text"></i>
						</span> <span>Bike</span>
					</a> <!-- this for sublist of Bike -->
						<ul class="nav lt">
							<li><a href="" class="active"> <span>New_Bike</span>
			...
			<!--End Sales -->
			<!-- This for View -->
			<li><a href="#view"> <i class="fa fa-user icon"> <b
						class="bg-warning"></b>
				</i> <span class="pull-right"> <i class="fa fa-angle-down text"></i>
						<i class="fa fa-angle-up text-active"></i>
				</span> <span>View</span>
				...
				<ul class="nav lt">
					<li><a href="salemanagerlist.html" class="active"> <i
							class="fa fa-angle-right"></i> <span>SalesManager</span>
					</a></li>
					<li><a href="servicemanagerlist.html" class="active"> <i
							class="fa fa-angle-right"></i> <span>ServiceManager</span>
					</a></li>
					<li><a href="accountantlist.html" class="active"> <i
							class="fa fa-angle-right"></i> <span>Accountant</span>
					</a></li>
					<li><a href="dealerlist.html" class="active"> <i
							class="fa fa-angle-right"></i> <span>Dealer</span>
					</a></li>
					<li><a href="userlist.html" class="active"> <i
							class="fa fa-angle-right"></i> <span>User</span>
					</a></li>
				</ul></li>
			<!-- End view -->
			</li>
			...
			<li><a href="notebook.html"> <i class="fa fa-pencil icon">
						<b class="bg-info"></b>
				</i> <span>Notes</span>
			</a></li>
		</ul>
	...
	</footer> </section> </aside> <!-- /.aside --> <section id="content"> <section
				...
				<div class="card-body">
					...
					<div class="form-group">
						<textarea id="compose-textarea" class="form-control"
							style="height: 300px" name="body">                      &lt;h1&gt;&lt;u&gt;Heading Of Message&lt;/u&gt;&lt;/h1&gt;
                                          &lt;h4&gt;Subheading&lt;/h4&gt;
	...
	<!-- End compose --> <aside class="bg-light lter b-l aside-md hide"
		id="notes">
	<div class="wrapper">Notification</div>
	</aside> </section> </section> </section> <!-- Bootstrap --> <!-- App --> <script
