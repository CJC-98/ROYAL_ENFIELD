        			...
        			<section class="vbox">
                        	...
                        	<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                               <li><a href="AdninIndex.html"><i class="fa fa-home"></i> Home</a></li>
                                ...
                                <li><a href="#">AvaliableService</a></li>
                             </ul>
                       <div class="m-b-md">
                            <h3 class="m-b-none">Avaliable Services</h3>
                       </div>
						<!-- Table  -->
						<div class="row ">
                        ...
                        <div class="container">
                                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table id="table" class="table table-bordered table-striped dataTable table-sm" 
                                  ...
                                  <tr role="row">
                                      <th class="sorting_asc" tabindex="0" aria-controls="example1" 
                                            ...
                                            style="width: 125px;" onclick="sortTable(0)">Service_Name
                                      </th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" 
                                            rowspan="1" colspan="1" aria-label="Browser: 
                                            activate to sort column ascending" 
                                            style="width: 125px;" onclick="sortTable(1)">Cost
                                        </th>
                                        
                                    </tr>
                                  </thead>
                                  <tbody>
                                  	<c:forEach items="${avaliableServicingInfoList}" var="avaliableServicingInfo">
                                  		<tr role="row" class="odd">
                                   		<td>${avaliableServicingInfo.serviceName}</td>
                                    	<td>${avaliableServicingInfo.cost}</td>
                                    	</tr>
                                    </c:forEach>
