...
<body class="">
	...
	<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
		...
		<li><a href="#">AccessoriesDeadStock</a></li>
	</ul>
	<div class="m-b-md">
		<h3 class="m-b-none">AccessoriesDeadStock</h3>
	</div>
	<!-- Table  --> <section class="panel panel-default">
	<div class="row ">
							...
							aria-describedby="example1_info">
								...
								<tr role="row">
									...
									<th class="sorting_asc" tabindex="0" aria-controls="example1"
										rowspan="1" colspan="1" aria-sort="ascending"
										aria-label="Rendering engine: activate to sort column descending"
										style="width: 125px;" onclick="sortTable(2)">Part_Price</th>
									<th class="sorting_asc" tabindex="0" aria-controls="example1"
										rowspan="1" colspan="1" aria-sort="ascending"
										aria-label="Rendering engine: activate to sort column descending"
										style="width: 125px;"  onclick="sortTable(3)">Part_Quantity</th>
                              </tr>
							</thead>
							<tbody>
