        			...
        			<section class="vbox">
           				 <section class="scrollable padder">
                       					<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                                				...
                                				<li><a href="#">Bike_Servicing</a></li>
                                			</ul>
                            			<div class="m-b-md">
                                			<h3 class="m-b-none">Servicing</h3>
                            			</div>
	<!-- Table  -->
                                ...
                                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                  ...
                                  <tr role="row">
                                      <th class="sorting_asc" tabindex="0" aria-controls="example1" 
                                            ...
                                            style="width: 125px;" onclick="sortTable(0)">Servicing_Status
                                      </th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" 
                                            rowspan="1" colspan="1" aria-label="Browser: 
                                            activate to sort column ascending" 
                                            style="width: 125px;"onclick="sortTable(1)">Appiontment_Date
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" 
                                            rowspan="1" colspan="1" aria-label="Platform(s): 
                                            activate to sort column ascending" 
                                            style="width: 125px;"onclick="sortTable(2)">Bike_Reales_Status
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" 
                                             rowspan="1" colspan="1" 
                                            aria-label="Engine version: activate to sort column ascending" 
                                            style="width: 125px;"onclick="sortTable(3)">Chasis_Number
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" 
                                             rowspan="1" colspan="1" 
                                            aria-label="Engine version: activate to sort column ascending" 
                                            style="width: 125px;"onclick="sortTable(4)">Plate_Number
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" 
                                             rowspan="1" colspan="1" 
                                            aria-label="Engine version: activate to sort column ascending" 
                                            style="width: 125px;"onclick="sortTable(5)">Amount
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" 
                                             rowspan="1" colspan="1" 
                                            aria-label="Engine version: activate to sort column ascending" 
                                            style="width: 125px;"onclick="sortTable(6)">Total_Amount
                                        </th>
                                        
                                    </tr>
                                  </thead>
                                  <tbody>
                                  <c:forEach items="${bikeServicingInfoList }" var="bikeServicingInfo" >
                                    <tr role="row" class="odd">
                                    <td>${bikeServicingInfo.servcingStatus}</td>
                                    <td>${bikeServicingInfo.appointmentDate}</td>
                                    <td>${bikeServicingInfo.bikeReleaseStatus}</td>
                                    <td>${bikeServicingInfo.servcingBikeInfo.chasisNumber}</td>
                                    <td>${bikeServicingInfo.servcingBikeInfo.plateNumber}</td>
                                    <td>${bikeServicingInfo.servicingInvoice.amount}</td>
                                    <td>${bikeServicingInfo.servicingInvoice.totalAmount}</td>
                                    </tr>
                                  </c:forEach>
                                  ...
                                  <tfoot>
                                  <tr>
                                 	 <th rowspan="1" colspan="1">Servicing_Status</th>
                                    <th rowspan="1" colspan="1">Appointment_Date</th>
                                    <th rowspan="1" colspan="1">Bike_Reales_Status</th>
                                    <th rowspan="1" colspan="1">Chasis_Number</th>
                                    <th rowspan="1" colspan="1">Plate_Number</th>
