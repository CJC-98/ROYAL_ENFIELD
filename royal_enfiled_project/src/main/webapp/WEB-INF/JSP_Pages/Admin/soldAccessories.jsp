                ...
                <section id="content" class="bg-light lter">
                    <section class="vbox">
                        <section class="scrollable padder">
                            ...
                            <div class="m-b-md">
								<h3 class="m-b-none">Sold Accessories</h3>
							</div>
                                ...
                                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                  ...
                                  <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example1" 
                                            ...
                                            style="width: 125px;" onclick="sortTable(1)">Part_Name
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" 
                                            rowspan="1" colspan="1" aria-label="Platform(s): 
                                            activate to sort column ascending" 
                                            style="width: 125px;" onclick="sortTable(2)">Part_Price
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" 
                                             rowspan="1" colspan="1" 
                                            aria-label="Engine version: activate to sort column ascending" 
                                            style="width: 125px;"onclick="sortTable(3)">Part_Quantity
                                        </th>
                       
                                         <th class="sorting" tabindex="0" aria-controls="example1" 
                                             rowspan="1" colspan="1" 
                                            aria-label="Engine version: activate to sort column ascending" 
                                            style="width: 125px;"onclick="sortTable(4)">Bike_Model_Name
                                        </th>
                                 ...
                                 <c:forEach items="${soldAccessoriesInfoList}" var="soldAccessoriesInfo">
                                  ...
                                  <tr>
                                    ...
                                    <th rowspan="1" colspan="1">Bike_Model_Name</th>
                                    </tr>
                                  </tfoot>
                                </table>
                            </div>
