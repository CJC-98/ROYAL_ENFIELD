					...
					<div class="panel-body">
								...
								<div class="row">
									...
									<div class="col-md-6 countryClass">
										<input type="text" class="form-control"
											...
											name="employeeCountryName" onchange="getCountryList(this.value)" required>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<c:if test="${checkDesignation==1}">
								<input type="hidden" name="employeeDesignation" value="">
								</c:if>
								<c:if test="${checkDesignation==1}" value="">
								<input type="hidden" name="employeeDesignation" value>
								</c:if>
								<c:if test="${checkDesignation==1}">
