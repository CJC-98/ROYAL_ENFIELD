                                ...
                                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                  ...
                                  <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example1" 
                                             rowspan="1" colspan="1" 
                                            aria-label="Engine version: activate to sort column ascending" 
                                            style="width: 125px;">Visiting_Date
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" 
                                             rowspan="1" colspan="1" 
                                            aria-label="Engine version: activate to sort column ascending" 
                                            style="width: 125px;">Test_Drive_Date
                                        </th>
                                  ...
                                  <tr>
                                    ...
                                    <th rowspan="1" colspan="1">Visiting_Date</th>
                                    <th rowspan="1" colspan="1">Test_Drive_Date</th>
                                    </tr>
                                  </tfoot>
                                </table>
                            </div>
