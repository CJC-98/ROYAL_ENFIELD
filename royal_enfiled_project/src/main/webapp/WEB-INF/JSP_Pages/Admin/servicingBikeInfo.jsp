...
<body class="">
	...
	<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
		...
		<li><a href="#">ServicingBikeInfo</a></li>
	</ul>
	<div class="m-b-md">
		<h3 class="m-b-none">Bikes for Servicing</h3>
	</div>
	<div class="row ">
				...
				<div class="row">
					<div class="col-sm-12">
						<table id="example1"
							...
							<thead>
								<tr role="row">
									...
									<th class="sorting_asc" tabindex="0" aria-controls="example1"
										rowspan="1" colspan="1" aria-sort="ascending"
										aria-label="Rendering engine: activate to sort column descending"
										style="width: 125px;">Plate_Number</th>
							...
							<tbody>
							<c:forEach items="${ servcingBikeInfoList}" var="servcingBikeInfo">
								<tr role="row" class="odd">
									
									<td>${servcingBikeInfo.chasisNumber }</td>
                                    <td>${servcingBikeInfo.plateNumber }</td>
