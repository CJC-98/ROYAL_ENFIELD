	...
	<section id="content"  class="bg-light lter">
	        <section class="vbox">
	            <section class="scrollable padder">                                               
	                ...
	                <div class="m-b-md">
	                    <h3 class="m-b-none" style="text-align: center; font-size: 30pxl; font-weight: bold;">View Accessories </h3>	               
	                </div>
                	...
                	<div class="col-sm-12">
                                    <section class="panel panel-default">
                                        <table class="table table-striped m-b-none b-a">
                                            <thead>
                                                <tr>
                                                    <th style="text-align: center">VAId</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr style="text-align: center">
                                                         ...
                                                         <td style="color: #FF681B">Classic350</td>
                                                         
                                                         <td style="color: #81EF19">Tyre</td>
                                                </tr>
