							...
							<div class="col-md-5">
								<div class="form-group">
									<img
										...
										alt="Smiley face" height="120" width="120" id="uploadPreview">
								</div>
							</div>
							</div>
                <!-- file tag -->
                    ...
                    <div class="form-group"> <label class="control-label">Bike Color</label> <input required="required" type="text" name="bikeColor" placeholder="Enter Bike Color"
                            class="form-control input-lg"> </div>
                    <div class="form-group"> <label class="control-label">Bike Engine Type</label> <input required="required" type="text" name="bikeEngine"
