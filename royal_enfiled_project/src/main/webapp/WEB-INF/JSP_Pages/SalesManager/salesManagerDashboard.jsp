                            ...
                            <section class="panel bg-dark">
                                        <div class="carousel slide carousel-fade panel-body" id="c-fade">
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                <div class="item">
                                                    <p class="text-center"> <em class="h4 text-mute"><img src="${pageContext.request.contextPath}/Resources/images/bike4.jpg" class="m-r-sm" width="750" height="500"></em><br> <small class="text-muted"><h3>Interceptor</h3></small>
                                                    </p>
                                                </div>
