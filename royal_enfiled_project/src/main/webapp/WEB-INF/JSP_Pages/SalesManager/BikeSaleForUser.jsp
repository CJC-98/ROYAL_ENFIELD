            ...
            <section class="panel panel-default m-t-lg bg-white">
                <header class="panel-heading text-center"> <strong>BikeSaleForUser</strong> </header>
                    ...
                    <form action="http://flatfull.com/themes/note/index.html" class="panel-body wrapper-lg">
                        ...
                        <div class="form-group"> <label class="col-sm-3 control-label">BikeEngineType</label>
                            <select data-required="true" class="form-control m-t">
                        ...
                        <div class="form-group"> <label class="col-sm-3 control-label">BikeColor</label>
                            <select data-required="true" class="form-control m-t">
                        ...
                        <div class="form-group"> <label class="control-label">Bike Wheel</label> <input type="text" name="bikewheel"
                            placeholder="Enter Bike Wheel Type" class="form-control input-lg"> </div>
                            <div class="form-group"> <label class="control-label">ShowroomPrice</label> <input type="text" name="showroomPrice"
                            placeholder="Enter Bike ShowRoom Price" class="form-control input-lg"> </div>
                            <div class="form-group"> <label class="control-label">OnRoadPricePrice</label> <input type="text" name="bikeOnRoadPrice"
                            placeholder="Enter Bike OnRoadPrice" class="form-control input-lg"> </div>
                            <div class="form-group"> <label class="control-label">EngineStartingType</label> <input type="text" name="engineStartingType"
                            placeholder="Enter Bike OnRoadPrice" class="form-control input-lg"> </div>
