                            ...
                            <section class="panel bg-dark">
                                        <div class="carousel slide carousel-fade panel-body" id="c-fade">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="item">
                                                    <p class="text-center"> <em class="h4 text-mute"><img src="${pageContext.request.contextPath}/Resources/images/Continental GT.jpg" class="m-r-sm" width="750" height="500"></em><br>
                                                        <small class="text-muted"><h3>Continental GT</h3></small> </p>
                                                </div>
                                                 <div class="item">
                                                    <p class="text-center"> <em class="h4 text-mute"><img src="${pageContext.request.contextPath}/Resources/images/DS.jpg" class="m-r-sm" width="750" height="500"></em><br> <small class="text-muted"><h3>Classic</h3></small>
                                                    </p>
                                                </div>
                                                <div class="item active">
                                                    <p class="text-center"> <em class="h4 text-mute"><img src="${pageContext.request.contextPath}/Resources/images/Himalayan2.jpg" class="m-r-sm" width="750" height="500"></em><br> <small class="text-muted"><h3>Himalayan</h3></small>
                                                    </p>
                                                </div>
                                                <div class="item">
                                                    <p class="text-center"> <em class="h4 text-mute"><img src="${pageContext.request.contextPath}/Resources/images/Thunderbird11.jpg" class="m-r-sm" width="750" height="500"></em><br> <small class="text-muted"><h3>Thunderbird</h3></small>
                                                    </p>
                                                </div>
                                                <div class="item">
                                                    <p class="text-center"> <em class="h4 text-mute"><img src="${pageContext.request.contextPath}/Resources/images/interceptor.jpg" class="m-r-sm" width="750" height="500"></em><br> <small class="text-muted"><h3>Interceptor</h3></small>
                                                    </p>
                                                </div>
