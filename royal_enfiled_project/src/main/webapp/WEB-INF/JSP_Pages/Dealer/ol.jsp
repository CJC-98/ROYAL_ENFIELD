	...
	<section id="content">
		<section class="vbox">
			<section class="scrollable padder">
				...
				<div class="thumbnail">
					<img src="${pageContext.request.contextPath}Resources/Royal Enfield images/gallary images/old.jpg"
						width="276px" height="376px" alt="">
					<div class="caption cntr">
						<centre>
						<p><a:out value="${data.bikemodel.modelName}"></a:out></p>
						</centre>
						<p>
							<strong><a:out value="${data.showroomPrice}"></a:out></strong>
						</p>
